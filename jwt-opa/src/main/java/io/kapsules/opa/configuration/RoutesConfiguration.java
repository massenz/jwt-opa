...
package io.kapsules.opa.configuration;
...
import static io.kapsules.opa.Constants.DEFAULT_HEALTH_ROUTE;
import static io.kapsules.opa.Constants.DEFAULT_LOGIN_ROUTE;
...
public class RoutesConfiguration {
  ...
  public static class RoutesProperties {
    ...
    List<String> allowed = List.of(DEFAULT_HEALTH_ROUTE);
    List<String> authenticated = List.of(DEFAULT_LOGIN_ROUTE);
  }
